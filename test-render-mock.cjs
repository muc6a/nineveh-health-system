...
var SuperAdminPanel = () => {
  ...
  const [showAddTeamModal, setShowAddTeamModal] = (0, import_react5.useState)(false);
  const [showEditTeamModal, setShowEditTeamModal] = (0, import_react5.useState)(false);
...
var mockContext = {
  ...
  config: { headerText: "", allowImageUpload: true, allowExternalReports: true, imageRetention: "", uiScale: "" },
  setConfig: () => {
  },
  ...
  auditLogs: [],
  publicCMS: { heroTitle: "", heroSubtext: "", announcement: "" },
  setPublicCMS: () => {
  }
};
try {
  (0, import_server.renderToString)(
    /* @__PURE__ */ import_react6.default.createElement(AppContext.Provider, { value: mockContext }, /* @__PURE__ */ import_react6.default.createElement(SuperAdminPanel, null))
  );
