...
# Wrap the end of the div with the closing brace for hasPerm('quickTeamDispatch')
# We need to find where the div closes. Looking at the code output:
#               </table>
#             </div>
#           </div>
#           </div>
...
print("Fixed ExecutivePortal Quick Dispatch Section")
