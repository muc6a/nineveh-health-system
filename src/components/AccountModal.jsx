    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-950/80 dark:bg-slate-900/40 backdrop-blur-md">
      <div className="w-full max-w-2xl bg-slate-900/95 dark:bg-white/90 backdrop-blur-xl border border-white/10 dark:border-slate-200 rounded-[2rem] text-white dark:text-slate-800 shadow-[0_0_50px_-12px_rgba(168,85,247,0.3)] relative text-right max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/5 bg-slate-900/40 dark:bg-white/50 sticky top-0 z-20 backdrop-blur-sm">
          ...
          <button onClick={onClose} className="flex p-2.5 rounded-xl bg-slate-100 hover:bg-white/5 dark:bg-slate-200 dark:hover:bg-white/10 text-slate-300 dark:text-slate-600 transition-all items-center justify-center group shadow-sm border border-white/5 dark:border-slate-200">
        ...
        <div className="p-6">
          ...
          {accountType === 'team' && (
            <>
              ...
              <div className="space-y-2">
                <label className="text-indigo-400 dark:text-indigo-600 flex items-center gap-2"><MapPin className="w-4 h-4"/> 1. تحديد الموقع وتوزيع الأحياء</label>
                {renderGeoSelection()}
              </div>
              ...
              <div className="space-y-3 pt-6 border-t border-white/5">
                ...
                <div className="bg-slate-800/40 dark:bg-slate-100/40 p-5 rounded-2xl border border-white/5 dark:border-slate-200 space-y-6">
                  <div>
                    ...
                    <button type="button" onClick={() => setDoctors([...doctors, { name: '', title: 'طبيب / مفتش' }])} className="text-indigo-400 dark:text-indigo-600 text-xs font-black hover:text-indigo-300 flex items-center gap-1 transition-colors">
                  ...
                  <div className="pt-4 border-t border-white/5">
                    ...
                    <button type="button" onClick={() => setAssistants([...assistants, { name: '', title: 'ملاحظ فني / مدقق' }])} className="text-indigo-400 dark:text-indigo-600 text-xs font-black hover:text-indigo-300 flex items-center gap-1 transition-colors">
                      <Plus className="w-3 h-3" /> إضافة عضو آخر
                    </button>
                  </div>
                </div>
          ...
          {accountType === 'director' && (
            <>
              ...
              <div className="space-y-2 pt-4 border-t border-slate-800">
                <label className="text-indigo-400 dark:text-indigo-600 flex items-center gap-2"><Briefcase className="w-4 h-4"/> 2. المسمى الوظيفي / المنصب (قابل للتعديل)</label>
                <input 
                  type="text" 
                  list="roles-list"
                  required 
              ...
              <div className="space-y-2 pt-4 border-t border-slate-800">
                <label className="text-indigo-400 dark:text-indigo-600 flex items-center gap-2"><MapPin className="w-4 h-4"/> 3. الربط الجغرافي ونطاق الصلاحية التقنية</label>
                
                <div className="flex gap-4 mb-4">
                  <label className="flex items-center gap-2 text-slate-300 dark:text-slate-600 cursor-pointer text-xs font-bold">
          ...
          {accountType === 'tracker' && (
            <>
              ...
              <div className="space-y-2 pt-4 border-t border-slate-800">
                <label className="text-indigo-400 dark:text-indigo-600 flex items-center gap-2"><MapPin className="w-4 h-4"/> 2. ربط المتابع بقطاع الفريق الميداني</label>
                <select 
                  required 
          ...
          <div className="space-y-4 pt-4 border-t border-slate-800">
            <label className="text-indigo-400 dark:text-indigo-600 flex items-center gap-2"><Lock className="w-4 h-4"/> {accountType === 'team' ? '4. بيانات حساب الفريق' : '4. بيانات تسجيل الدخول'}</label>
