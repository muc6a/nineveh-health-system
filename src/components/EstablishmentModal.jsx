...
export const EstablishmentModal = ({ isOpen, mode, initialData, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/40 dark:bg-slate-950/80 backdrop-blur-md text-right" dir="rtl">
      <div className="w-full max-w-2xl bg-slate-900/95 dark:bg-white/90 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-[2rem] text-white dark:text-slate-800 shadow-[0_0_50px_-12px_rgba(99,102,241,0.3)] relative overflow-hidden flex flex-col max-h-[90vh]">
        
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-white/5 bg-slate-900/50 dark:bg-white/40 sticky top-0 z-20 backdrop-blur-sm shrink-0">
          ...
          <form id="establishment-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-white/10 text-white dark:text-slate-800 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/30 transition-all shadow-inner font-bold text-sm"
                />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-400 flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="07..."
                  className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-white/10 text-white dark:text-slate-800 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/30 transition-all shadow-inner font-bold text-sm text-left"
                  dir="ltr"
                />
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full p-3.5 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-300 dark:border-white/10 text-white dark:text-slate-800 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/30 transition-all shadow-inner font-bold text-xs"
                  >
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-white/10 text-white dark:text-slate-800 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/30 transition-all shadow-inner font-bold text-sm min-h-[100px]"
              />
            </div>
        ...
        {/* Footer Actions */}
        <div className="p-6 border-t border-slate-200 dark:border-white/5 bg-slate-900/50 dark:bg-white/40 flex items-center justify-end gap-3 shrink-0 backdrop-blur-sm">
          <button
            type="button"
            onClick={onClose}
