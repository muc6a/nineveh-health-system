  ...
  const estWithCoords = React.useMemo(() => {
    return establishments.map((est, i) => {
      ...
      const baseCoords = {
        ...
        'قضاء تلعفر': [36.3758, 42.4542],
        'سنجار': [36.3209, 41.8368],
        'قضاء سنجار': [36.3209, 41.8368],
        'البعاج': [36.0469, 41.8081],
        'قضاء البعاج': [36.0469, 41.8081],
        'الحضر': [35.5802, 42.7231],
        'قضاء الحضر': [35.5802, 42.7231],
        'الحمدانية': [36.2713, 43.3755],
        'قضاء الحمدانية': [36.2713, 43.3755]
      };
