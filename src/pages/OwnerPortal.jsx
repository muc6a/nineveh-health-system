      ...
      <main className="flex-1 relative max-w-full overflow-hidden print:overflow-visible">
        ...
        <div className="hidden qr-poster-wrapper">
           <div ref={qrPosterRef} className="print-only-qr relative w-[794px] h-[1122px] bg-white text-slate-900 mx-auto print:scale-100 origin-top overflow-hidden">
             ...
             <div className="absolute top-[260px] left-0 right-0 flex justify-center px-12 z-10">
             ...
             <div className="absolute top-[380px] left-0 right-0 flex justify-center z-10 mt-8">
