...
import { Archive, Image, FileText, ArrowRight, ArrowLeft, Plus, Trash2, DollarSign, Edit, X, Power, ShieldAlert, Check, Users, Settings, Database, Shield, Eye, EyeOff, Info, UserPlus, Compass, Building, Search, Mail, AlertTriangle, BarChart3, BellRing, Globe, Activity, Bell, Lock, Unlock, Gavel, Save, ChevronLeft, ChevronRight, ChevronDown, HardDrive, CheckCircle, Play, Upload, RefreshCcw, Ban, MapPin, Banknote } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 dark:bg-slate-950/80 backdrop-blur-sm">
          <div className="w-full max-w-lg bg-slate-900 border border-slate-700/60 p-6 rounded-3xl text-white shadow-2xl relative text-right">
            ...
            <div className="flex items-center justify-between pb-3.5 border-b border-slate-800 mb-4">
              <h3 className="text-sm font-black text-teal-600 dark:text-teal-400">🔍 بطاقة معلومات الحساب بالتفصيل</h3>
              <button 
            ...
            <div className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <span className="text-[10px] text-slate-400 block mb-1">اسم الحساب</span>
              ...
              <div className="w-full md:w-1/3 bg-slate-100/50 dark:bg-slate-900/50 border-l border-slate-200 dark:border-white/5 p-6 flex flex-col relative z-10 shrink-0 md:overflow-y-auto custom-scrollbar">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-lg font-black text-transparent bg-clip-text bg-gradient-to-l from-purple-600 to-indigo-600 dark:from-purple-400 dark:to-indigo-400 flex items-center gap-2 drop-shadow-sm">
                    <Settings className="w-5 h-5 text-purple-400" /> مركز الصلاحيات
                  </h3>
            ...
            <form onSubmit={handleCreateTeam} className="space-y-4 text-xs font-bold text-right">
                  ...
                  <div className="pt-3 border-t border-slate-800 space-y-2">
                    ...
                    <p className="text-[9px] text-slate-400 leading-relaxed">
                      تنويه: سيتم منح هذا الفريق الصلاحيات الأساسية (إضافة وتقييم المنشآت) افتراضياً. يمكنك تعديل الصلاحيات بشكل دقيق (مثل منح إذن الحذف) من خلال خيار "الصلاحيات" في جدول اللجان بعد الإنشاء.
                    </p>
                  </div>
